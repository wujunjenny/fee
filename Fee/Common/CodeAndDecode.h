...
#if !defined(__CodeAndDecode__h__)
#define __CodeAndDecode__h__
...
//////////////////////////////////////////////////////////////////////
// CodeAndDecode.h: interface for the CodeAndDecode class.
//
...
public:
	...
	int  ConvertBigTextToUCS2(LPCSTR pString,UC* pData,US& nLen);
...
#endif // !defined(__CodeAndDecode__h__)
